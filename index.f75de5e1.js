...
function updateButtons() {
    if (countRows >= MAX) buttonAppendRow.disabled = true;
    else buttonAppendRow.disabled = false;
    if (countRows <= MIN) buttonRemoveRow.disabled = true;
    else buttonRemoveRow.disabled = false;
    if (countCols >= MAX) buttonAppendCol.disabled = true;
    else buttonAppendCol.disabled = false;
    if (countCols <= MIN) buttonRemoveCol.disabled = true;
    else buttonRemoveCol.disabled = false;
}
...
function updateCounts() {
    ...
    if (dataRow) countCols = dataRow.querySelectorAll("td").length;
    else countCols = table.querySelectorAll("th").length;
}
